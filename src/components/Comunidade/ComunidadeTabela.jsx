...
const ComunidadaTabela = ({ comunidades = [], setComunidades }) => {
    ...
    const currentComunidades = comunidades.slice(indexOfFirstCommunity, indexOfLastCommunity);
    ...
    const deleteComunidade = async () => {
        try {
            ...
            setComunidades(
                comunidades.filter((comunidade) => comunidade.id !== comunidadeSelecionada)
            );
            closeModal();
    ...
    {currentComunidades.map((comunidade) => (
            ...
            <td>
                {editingCommunityId === comunidade.id ? (
                    <input
                        ...
                        onChange={(e) => handleEditingChange("descricao", e.target.value)}
                    />
                ) : (
            ...
            <td>
                {editingCommunityId === comunidade.id ? (
                    <input
                        ...
                        onChange={(e) => handleEditingChange("integrantes", e.target.value)}
                    />
                ) : (
      ...
      <div className="text-end mt-3">
        <a href="/funcionario/comunidade/novacomunidade" className="btn btn-sucess">
        <FaPlus /> Nova Comunidade
        </a>
      </div>
    </section>
    )};
    export default ComunidadaTabela;
